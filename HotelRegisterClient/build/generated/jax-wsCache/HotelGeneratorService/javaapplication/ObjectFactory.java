 ...
 * generated in the javaapplication package. 
...
public class ObjectFactory {
    ...
    private final static QName _InsertClientName_QNAME = new QName("http://tempuri.org/", "name");
    private final static QName _InsertClientLast_QNAME = new QName("http://tempuri.org/", "last");
    ...
    private final static QName _TableApellidos_QNAME = new QName("http://schemas.datacontract.org/2004/07/HotelService.Models", "Apellidos");
    private final static QName _TableCorreo_QNAME = new QName("http://schemas.datacontract.org/2004/07/HotelService.Models", "Correo");
    private final static QName _TableNombre_QNAME = new QName("http://schemas.datacontract.org/2004/07/HotelService.Models", "Nombre");
    private final static QName _TableTelefono_QNAME = new QName("http://schemas.datacontract.org/2004/07/HotelService.Models", "Telefono");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: javaapplication
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "name", scope = InsertClient.class)
    public JAXBElement<String> createInsertClientName(String value) {
        return new JAXBElement<String>(_InsertClientName_QNAME, String.class, InsertClient.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "last", scope = InsertClient.class)
    public JAXBElement<String> createInsertClientLast(String value) {
        return new JAXBElement<String>(_InsertClientLast_QNAME, String.class, InsertClient.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/HotelService.Models", name = "Apellidos", scope = Table.class)
    public JAXBElement<String> createTableApellidos(String value) {
        return new JAXBElement<String>(_TableApellidos_QNAME, String.class, Table.class, value);
    }
    ...
    public JAXBElement<String> createTableCorreo(String value) {
        return new JAXBElement<String>(_TableCorreo_QNAME, String.class, Table.class, value);
    }
    ...
    public JAXBElement<String> createTableNombre(String value) {
        return new JAXBElement<String>(_TableNombre_QNAME, String.class, Table.class, value);
    }
    ...
    public JAXBElement<String> createTableTelefono(String value) {
        return new JAXBElement<String>(_TableTelefono_QNAME, String.class, Table.class, value);
    }
