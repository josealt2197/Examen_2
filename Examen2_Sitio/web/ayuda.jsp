...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="form-row ">
                    <div class="col-md-6 mx-auto">
                        <h2 style="color: #0A2A70;background-color: rgba(255, 255, 255, 0.3);width: 80%; margin: auto;">Preguntas Frecuentes<span class="pl-2"><img src="img/costa-rica64.png"></span></h2>                                                  
                    </div><br>
                </div>
            </div>
        </section><br><br> 
        ...
        <div class="container">            
            <div class="row">
                <div class="col">            
                    <div class="card" style="width:400px; border: solid 2px #28A745;">
