                ...
                <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
                    <div class="row">
                        <div class="col-md-6 mr-5 px-0">
                            ...
                            <div class="col-md-3">
                                <a class="btn btn-success btn-lg btn-block" href="reservacion_vehiculo.action?submitType=updatedata&id_vehiculo=<s:property value="idVehiculo"></s:property>">Reservar</a>
                            </div>
                        </div>
                        <img src="<s:property value="imagen.getValue()"></s:property>" data-highres="<s:property value="ImagenDetail.getValue()"></s:property>" alt="Imagen" width="700">
                    </div>
