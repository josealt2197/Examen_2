		...
		<div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
			<div class="row">
				<div class="col-md-6 mr-5 px-0">
					<h1 class="display-5 font-italic">Chevrolet Tahoe</h1>
					<span class="badge badge-primary badge-pill">SUV</span><span class="ml-3 badge badge-info">Ideal para familias grandes</span>
					<p></p>
				</div><br><br>
				<div class="col-md-3">
		...
		<div class="row">
			<div class="col-md-6 blog-main">
				...
				<div class="blog-post">
					...
					<p>- Precio x día: $393</p>
					<p>- Transmisión Automático</p>
					<p>- Hasta 8 Pasajeros</p>
					<p>- Kilometraje ilimitado</p>
					<p>- Aire Acondicionado</p>
					<p>- Propietario: Alamo</p>
			...
			<aside class="col-md-6 blog-sidebar">
				<div class="p-4 mb-3 bg-light rounded">
					<h4 class="font-italic">Extras</h4><br>
					<p class="mb-0"><strong>GPS: </strong> Incluido</p><br>
					<p class="mb-0"><strong>Asiento para bebés: </strong> No incluido</p><br>
					<p class="mb-0"><strong>Asiento para niños: </strong> No incluido</p><br>
					<p class="mb-0"><strong>Bike Rack: </strong> No incluido</p><br>               
				</div>
			</aside>
