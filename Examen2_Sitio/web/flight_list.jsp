    ...
    <div class="col-md-8 mx-auto">
      <div class="card mb-4 box-shadow h-md-250">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4 mx-auto">
              <p><strong>SJO - MIA</strong></p>
              <p><strong>3h 02min</strong></p>  
            </div>
      ...
      <div class="card mb-4 box-shadow h-md-250">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mx-auto">
              <p><strong>Copa Airlines</strong></p>
              <br><a class="btn btn-success" href="#">Leer más</a>
            </div>
